...
function addMovie(req, res) {
    ...
    const sql = `INSERT INTO specificMovies (title, release_date, poster_path, overview, comment)    VALUES('${mov.movieTitle}','${mov.release_date}' ,'${mov.poster_path}' ,'${mov.overview}','${mov.comment}') ;`
